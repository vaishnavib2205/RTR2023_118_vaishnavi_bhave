...
void display(void)
{
	...
	rotationMatrix = XMMatrixRotationY(XMConvertToRadians(angle_Triangle));  // if angle sign (+) then rotation in left to right , and vice versa for (-)
