...
{ 
    ...
    mat4.translate(modelViewMatrix , modelViewMatrix , [0.0, 0.0 , -20.0]); // source , target , values


    pushMatrix(modelViewMatrix);

    mat4.rotate(modelViewMatrix , modelViewMatrix , parseFloat(shoulder) , [0.0, 0.0 , 1.0] );
    ...
    mat4.scale(modelViewMatrix , modelViewMatrix , [3.0, 1.0 , 1.0]); // source , target , values
    ...
    mat4.translate(modelViewMatrix , modelViewMatrix , [1.0, 0.0, 0.0]);
    mat4.rotate(modelViewMatrix , modelViewMatrix , parseFloat(elbow) , [0.0, 0.0 , 1.0] );
    mat4.translate(modelViewMatrix , modelViewMatrix , [1.0, 0.0, 0.0]);
    ...
    mat4.scale(modelViewMatrix , modelViewMatrix , [1.0, 1.0 , 1.0]); // source , target , values
    ...
    mat4.translate(modelViewMatrix , modelViewMatrix , [1.0, 0.0, 0.0]);
    mat4.rotate(modelViewMatrix , modelViewMatrix , parseFloat(wrist) , [0.0, 0.0 , 1.0] );
    ...
    mat4.scale(modelViewMatrix , modelViewMatrix , [0.5, 1.0 , 2.0]); // source , target , values
