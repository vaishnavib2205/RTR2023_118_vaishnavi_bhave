...
-(void)display
{
    ...
    // square
    {
        ...
        rotationMatrix = vmath::rotate(angle_Rectangle, 0.0f, 1.0f, 0.0f);

        modelViewMatrix = translationMatrix * rotationMatrix;

        mat4 modelViewProjectionMatrix = mat4::identity();
        modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix; // order of multiplication
...
{
    // Code
    angle_Rectangle += 1.5f;
    if (angle_Rectangle >= 360.0f)
    {
        angle_Rectangle -= 360.0f;
    }
