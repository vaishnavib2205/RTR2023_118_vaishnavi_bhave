...
GLfloat trianglexTranslate = -7.0f;
GLfloat triangleyTranslate = -7.0f;
GLfloat circlexTranslate = 7.0f;
GLfloat circleyTranslate = -7.0f;
GLfloat LinexTranslate = 0.0f;
GLfloat LineyTranslate = 7.0f;
GLfloat rAngle = 0.0f;
...
glTranslatef(trianglexTranslate, trianglexTranslate, -9.0f);
glRotatef(rAngle, 0.0f, 1.0f, 0.0f);

glLineWidth(2.0f);
glBegin(GL_LINE_LOOP);
glVertex3f(-2.0, -2.0, 0.0f);
glVertex3f(2.0, -2.0, 0.0f);
glVertex3f(0.0f, 2.0, 0.0f);
glEnd();
...
float q = 0.0f;
float radius;
semiPerimeter = (4.2f + 4.2f + 4.2f) / 2.0f;
Area = sqrt(semiPerimeter * (semiPerimeter - 4.2f) * (semiPerimeter - 4.2f) * (semiPerimeter - 4.2f));

radius = Area / semiPerimeter;

glLoadIdentity();
glTranslatef(circlexTranslate, circleyTranslate, -9.0f);
glRotatef(rAngle, 0.0f, 1.0f, 0.0f);
glPointSize(2.0f);
glBegin(GL_POINTS);

for (float i = 0.0f; i < 360.0f; i = i + 0.10f) {

p = radius * cos(i);
q = radius * sin(i);
glColor3f(1.0f, 1.0f, 1.0f);
glVertex3f(p, q + (-0.77), 0.0f);  // (ay1 + by2 + cy3) / (a + b + c)

}
glEnd();

glLoadIdentity();
glTranslatef(LinexTranslate, LineyTranslate, -9.0f);
glRotatef(rAngle, 0.0f, 1.0f, 0.0f);
glLineWidth(2.0f);
glBegin(GL_LINES);
glColor3f(1.0f, 1.0f, 1.0f);
...
{
	// Code
	if (trianglexTranslate < 0) 
	{
		trianglexTranslate += 0.0008f;
		circlexTranslate -= 0.0008f;
		circleyTranslate += 0.0008f;
		LineyTranslate -= 0.0008f;
