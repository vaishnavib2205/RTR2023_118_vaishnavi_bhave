...
mat4 orthographicProjectionMatrix = 0;
...
void display(void)
{
	...
	mat4 modelViewProjectionMatrix = orthographicProjectionMatrix * modelViewMatrix; //matrix mdhe multiplication la commutitive property that is a*b != b*a in matrices
