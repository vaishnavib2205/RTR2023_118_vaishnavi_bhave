...
function initialize() {
    ...
    gl.bindAttribLocation(shaderProgramObject, vertexAttributeEnum.AMC_ATTRIBUTE_NORMALS, "aNormal");
    ...
    gl.vertexAttribPointer(vertexAttributeEnum.AMC_ATTRIBUTE_NORMALS, 3, gl.FLOAT, false, 0, 0);
    gl.enableVertexAttribArray(vertexAttributeEnum.AMC_ATTRIBUTE_NORMALS);
    gl.bindBuffer(gl.ARRAY_BUFFER, null);
...
function display() {
    ...
    mat4.rotate(modelMatrix, modelMatrix, angle_Pyramid, [0.0, 1.0, 0.0]); // source , target , values
