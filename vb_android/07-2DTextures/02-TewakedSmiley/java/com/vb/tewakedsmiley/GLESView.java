...
import com.pb.tewakedsmiley.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private void initialize(GL10 gl)
    {
        ...
        keypressUniform = GLES32.glGetUniformLocation(shaderProgramObject, "ukey_used");
	...
	else
	{
        ...
        // 1. Allovate enough byte buffer
        ByteBuffer texture_Buffer = ByteBuffer.allocateDirect(square_texcoord.length * 4);
        ...
        // 4. now fill in the array into it
        textureBuffer.put(square_texcoord);

        // 5. now bring buffer to 0 after use
        textureBuffer.position(0);

        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, square_texcoord.length * 4 , textureBuffer , GLES32.GL_DYNAMIC_DRAW);
        GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
