...
var lightDiffuseUniform = new Array(3); // for diffuse light
var materialDiffuseUniform = 0; // for diffuse materia
var lightAmbientUniform = new Array(3); // for ambient light
var materialAmbientUniform = 0; // for ambient materia
var lightSpecularUniform = new Array(3); // for specular light
...
var lightDiffuseUniform_pv = new Array(3); // for diffuse light
var materialDiffuseUniform_pv = 0; // for diffuse materia
var lightAmbientUniform_pv = new Array(3); // for ambient light
var materialAmbientUniform_pv = 0; // for ambient materia
var lightSpecularUniform_pv = new Array(3); // for specular light
var materialSpecularUniform_pv = 0; // for specular material
var materialShinenessUniform_pv = 0; // for shinneness materia
...
var lightPosition_one = new Array(4);

var lightAmbient_two = [0.0, 0.0, 0.0];
var lightDiffuse_two = [0.0, 1.0, 0.0]; // white diffuse light
var lightSpecular_two = [0.0, 1.0, 0.0]; // white diffuse
var lightPosition_two = new Array(4);

var lightAmbient_three = [0.0, 0.0, 0.0];
var lightDiffuse_three = [0.0, 0.0, 1.0]; // white diffuse light
var lightSpecular_three = [0.0, 0.0, 1.0]; // white diffuse
var lightPosition_three = new Array(4);
...
function initialize() {
    ...
    // per fragment
    {
        ...
        lightAmbientUniform[0] = gl.getUniformLocation(shaderProgramObject_pf, "uLightAmbient[0]");
        lightDiffuseUniform[0] = gl.getUniformLocation(shaderProgramObject_pf, "uLightDiffuse[0]");
        lightSpecularUniform[0] = gl.getUniformLocation(shaderProgramObject_pf, "uLightSpecular[0]");
        lightPositionUniform[0] = gl.getUniformLocation(shaderProgramObject_pf, "uLightposition[0]");

        lightAmbientUniform[1] = gl.getUniformLocation(shaderProgramObject_pf, "uLightAmbient[1]");
        lightDiffuseUniform[1] = gl.getUniformLocation(shaderProgramObject_pf, "uLightDiffuse[1]");
        lightSpecularUniform[1] = gl.getUniformLocation(shaderProgramObject_pv, "uLightSpecular[1]");
        lightPositionUniform[1] = gl.getUniformLocation(shaderProgramObject_pf, "uLightposition[1]");

        lightAmbientUniform[2] = gl.getUniformLocation(shaderProgramObject_pf, "uLightAmbient[2]");
        lightDiffuseUniform[2] = gl.getUniformLocation(shaderProgramObject_pf, "uLightDiffuse[2]");
        lightSpecularUniform[2] = gl.getUniformLocation(shaderProgramObject_pf, "uLightSpecular[2]");
        lightPositionUniform[2] = gl.getUniformLocation(shaderProgramObject_pf, "uLightposition[2]");
...
function display() {
    ...
    if (bLightingEnabled == true) {
        if (bLightingEnabled_pv == true) {
            ...
            gl.uniform3fv(lightAmbientUniform_pv[0], lightAmbient_one);
            gl.uniform3fv(lightDiffuseUniform_pv[0], lightDiffuse_one);
            gl.uniform3fv(lightSpecularUniform_pv[0], lightSpecular_one);

            gl.uniform3fv(lightAmbientUniform_pv[1], lightAmbient_two);
            gl.uniform3fv(lightDiffuseUniform_pv[1], lightDiffuse_two);
            gl.uniform3fv(lightSpecularUniform_pv[1], lightSpecular_two);

            gl.uniform3fv(lightAmbientUniform_pv[2], lightAmbient_three);
            gl.uniform3fv(lightDiffuseUniform_pv[2], lightDiffuse_three);
            gl.uniform3fv(lightSpecularUniform_pv[2], lightSpecular_three);
            ...
            gl.uniform4fv(lightPositionUniform_pv[0], lightPosition_one);
            gl.uniform4fv(lightPositionUniform_pv[1], lightPosition_two);
            gl.uniform4fv(lightPositionUniform_pv[2], lightPosition_three);
            ...
            gl.uniform3fv(lightAmbientUniform[2], lightAmbient_three);
            gl.uniform3fv(lightDiffuseUniform[2], lightDiffuse_three);
            gl.uniform3fv(lightSpecularUniform[2], lightSpecular_three);
            ...
            gl.uniform4fv(lightPositionUniform[2], lightPosition_three);
...
function update() {
    //code
    if (bLightingEnabled == true) {
        lightPosition_one[0] = 0.0;
        lightPosition_one[1] = 5.0 * Math.sin(lightAngleZero);
        lightPosition_one[2] = 5.0 * Math.cos(lightAngleZero);
        lightPosition_one[3] = 1.0;


        lightPosition_two[0] = 5.0 * Math.cos(lightAngleOne);
        lightPosition_two[1] = 0.0;
        lightPosition_two[2] = 5.0 * Math.sin(lightAngleOne);
        lightPosition_two[3] = 1.0;


        lightPosition_three[0] = 5.0 * Math.cos(lightAngleTwo);
        lightPosition_three[1] = 5.0 * Math.sin(lightAngleTwo);
        lightPosition_three[2] = 0.0;
        lightPosition_three[3] = 1.0;
