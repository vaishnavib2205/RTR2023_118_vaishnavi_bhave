...
int initialize(void)
{
	...
	//length
		...
		{
			1.0f, 1.0f, 1.0f, //glColor3f(1.0f, 0.0f, 0.0f);
			1.0f, 1.0f, 1.0f, // glColor3f(0.0f, 1.0f, 0.0f); 
			1.0f, 1.0f, 1.0f  //glColor3f(0.0f, 0.0f, 1.0f); 
		};
		...
		{
			1.0f, 1.0f, 0.0f,    // glVertex3f(0.0f, 1.0f, 0.0f)
			-1.0f, 1.0f, 0.0f,    // glVertex3f(-1.0f, -1.0f, 0.0f)
			-1.0f, -1.0f, 0.0f,  //glVertex3f(1.0f, -1.0f, 0.0f)
			1.0f, -1.0f, 0.0f
		...
		// for color // single color asel tr vbo krychi garaj nahi
...
{
	// Code
	angle_triangle = angle_triangle + 0.09f;
	if (angle_triangle >= 360.0f) {
		angle_triangle = angle_triangle - 360.0f;
	}

	angle_square = angle_square - 0.09f;
	if (angle_square <= 0.0f) {
