...
int main(void)
{
	...
	struct MyPoint point; // declaring a single varaible of type 'struct MyPoint' locally...
	struct MyPointProperties point_properties; // declaring a single varaible of type 'struct MyPointProperties' locally...
