...
-(int)initialize
{
    ...
    // for tesselation control shader
    status = 0;
    infoLogLength = 0;
    szInfoLog = NULL;
    ...
    if (status == FALSE)
    {
        ...
        if (infoLogLength > 0)
        {
            ...
            if (szInfoLog != NULL)
            {
                ...
                fprintf(gpFile, "TCS Compilation Error Log : %s \n", szInfoLog);
                free(szInfoLog);
                szInfoLog = NULL;
            }
        }
    ...
    if (status == FALSE)
    {
        ...
        if (infoLogLength > 0)
        {
            ...
            if (szInfoLog != NULL)
            {
                ...
                fprintf(gpFile, "TES Compilation Error Log : %s \n", szInfoLog);
                free(szInfoLog);
                szInfoLog = NULL;
            }
        }
...
-(void)display
{
    ...
    // tell openGL by How many vertices your one path is created
