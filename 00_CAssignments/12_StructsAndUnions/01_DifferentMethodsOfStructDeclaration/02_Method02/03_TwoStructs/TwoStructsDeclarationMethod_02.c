...
struct MyPoint point; // declaring a single varaible of type 'struct MyPoint' globally...
struct MyPointProperties point_properties; // declaring a single varaible of type 'struct MyPointProperties' globally...
