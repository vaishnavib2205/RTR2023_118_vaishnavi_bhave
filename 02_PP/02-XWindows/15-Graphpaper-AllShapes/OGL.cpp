...
GLuint vao_blueLines = 0;
GLuint vbo_position_blueLines = 0;

GLuint vao_HorizontalBlueLines = 0;
GLuint vbo_position_HorizontalBlueLines= 0;
GLuint vbo_blueColor = 0;
...
int initialize(void)
{
	...
	glGenVertexArrays(1, &vao_blueLines);
	glBindVertexArray(vao_blueLines);
	...
	// verticle color
	glGenBuffers(1, &vbo_blueColor);
	glBindBuffer(GL_ARRAY_BUFFER, vbo_blueColor);
	...
	glGenVertexArrays(1, &vao_HorizontalBlueLines);
	glBindVertexArray(vao_HorizontalBlueLines);
