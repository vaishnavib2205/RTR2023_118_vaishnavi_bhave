package com.vb.texturedtwo3dshapes;
...
import com.pb.texturedtwo3dshapes.VertexAttributesEnum;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private float angle_Rect;
    private float angle_Triangle;    // for texture
    private int[] cubeTexture = new int[1];
    private int[] pyramidTexture = new int[1];
    ...
    private void initialize(GL10 gl)
    {
        ...
        // texcoords
        final float[] pyramid_texcoords = new float[]
        {
            // front
            0.5f, 1.0f, // front-top
...

        {
            ...
            // 1. Allovate enough byte buffer
            ByteBuffer texture_Buffer = ByteBuffer.allocateDirect(pyramid_texcoords.length * 4);
            ...
            // 4. now fill in the array into it
            textureBuffer.put(pyramid_texcoords);

            // 5. now bring buffer to 0 after use
            textureBuffer.position(0);

            GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, pyramid_texcoords.length * 4 , textureBuffer , GLES32.GL_STATIC_DRAW);
            GLES32.glVertexAttribPointer(VertexAttributesEnum.AMC_ATTRIBUTE_TEXCOORDS, 2, GLES32.GL_FLOAT, false, 0, 0);
            GLES32.glEnableVertexAttribArray(VertexAttributesEnum.AMC_ATTRIBUTE_TEXCOORDS);
            GLES32.glBindBuffer(GLES32.GL_ARRAY_BUFFER, 0);
        ...
        pyramidTexture[0] = loadGLTexture(R.raw.stone);
    ...
    private void display()
    {
        ...
        {   
            ...
            GLES32.glActiveTexture(GLES32.GL_TEXTURE0);
            GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, pyramidTexture[0]);
            GLES32.glUniform1i(textureSamplerUniform , 0);
