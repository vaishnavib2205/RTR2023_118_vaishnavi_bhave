...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_NUMPAD1:
		case 1:
			glViewport(0, 0, (GLsizei)widthr/2, (GLsizei)heightr/2);
			break;

		case VK_NUMPAD2:
		case 2:
			glViewport((GLsizei)widthr / 2, 0, (GLsizei)widthr / 2, (GLsizei)heightr / 2);
			break;

		case VK_NUMPAD3:
		case 3:
			glViewport((GLsizei)widthr / 2, (GLsizei)heightr / 2, (GLsizei)widthr / 2, (GLsizei)heightr / 2);
			break;

		case VK_NUMPAD4:
		case 4:
			glViewport(0, (GLsizei)heightr / 2, (GLsizei)widthr / 2, (GLsizei)heightr / 2);
			break;

		case VK_NUMPAD5:
		case 5:
			glViewport(0, 0, (GLsizei)widthr, (GLsizei)heightr / 2);
			break;

		case VK_NUMPAD6:
		case 6:
			glViewport(0, (GLsizei)heightr / 2, (GLsizei)widthr , (GLsizei)heightr / 2);
			break;

		case VK_NUMPAD7:
		case 7:
			glViewport(0, 0, (GLsizei)widthr / 2, (GLsizei)heightr );
			break;

		case VK_NUMPAD8:
		case 8:
			glViewport((GLsizei)widthr / 2, 0, (GLsizei)widthr / 2, (GLsizei)heightr);
			break;

		case VK_NUMPAD9:
		case 9:
			glViewport((GLsizei)widthr / 4, (GLsizei)heightr / 4, (GLsizei)widthr / 2, (GLsizei)heightr / 2);
			break;
