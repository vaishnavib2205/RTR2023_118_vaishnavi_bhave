package com.vb.colortwo3dshapes;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnDoubleTapListener,OnGestureListener
{
    ...
    private void initialize(GL10 gl)
    {
        ...
        {        // VAO = vertex array object
            ...
            // 1. Allovate enough byte buffer
            ByteBuffer byteBuffer_color = ByteBuffer.allocateDirect(cube_color.length * 4);
...

        {
            ...
            // 1. Allovate enough byte buffer
            ByteBuffer byteBufferColor = ByteBuffer.allocateDirect(pyramid_color.length * 4);
