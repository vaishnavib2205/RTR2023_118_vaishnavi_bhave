...
void display(void)
{
	...
	//	glBegin(GL_LINES);
	//	glColor3f(0.0f, 0.0f, 1.0f);
	//	glVertex3f(-0.738, count1, 0.0f);
	//	glVertex3f(0.738, count1, 0.0f);
	//	glVertex3f(-0.738, -count1, 0.0f);
	//	glVertex3f(0.738, -count1, 0.0f);
	//	count1 = count1 + 0.019f;
	//	glEnd();
	//}
	//
	//glLineWidth(2.5f);
	...
	//glVertex3f(0.779f, 0.0f, 0.0f);
	//glVertex3f(-0.779f, 0.0f, 0.0f);
	//glEnd();
	//
	//glBegin(GL_LINES);
	//glColor3f(0.0f, 1.0f, 0.0f);
	//glVertex3f(0.0f, 0.738f, 0.0f);
	//glVertex3f(0.0f, -0.738f, 0.0f);
	//
	//glEnd();
	
	//TriangleCode
	float XCenterIncrement = 0.1f;
	float YCenterIncrement = 0.1f;
	int numTriangles = 11;
	...
	for (int i = 0; i < numTriangles; i++) {
		...
		case 8:
			...
			//cyan
		case 7:
			glColor3f(0.87f, 1.0f, 1.0f);
			break;
			//magenta
		case 6:
			glColor3f(0.79f, 0.121f, 0.48f);
			break;
			//yellow
		case 5:
		...
		case 2:
			...
			break;
		case 1:
			glColor3f(0.47f, 0.31f, 0.66f);
			break;
		default:
			break;
		}
		glBegin(GL_LINE_LOOP);
		float x = i * XCenterIncrement;
		float y = i * YCenterIncrement;
		glVertex3f(-x, -y, 0.0f);
		glVertex3f(x, -y, 0.0f);
