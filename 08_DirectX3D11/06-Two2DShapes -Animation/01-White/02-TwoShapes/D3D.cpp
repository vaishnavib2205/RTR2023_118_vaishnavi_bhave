...
ID3D11Buffer *gpID3D11Buffer_PositionBuffer_t = NULL;   // analogous to genbuffers
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	gpID3D11DeviceContext->Unmap(gpID3D11Buffer_PositionBuffer , 0);
		...
		hr = gpID3D11Device->CreateBuffer(&d3dBufferDesc, NULL, &gpID3D11Buffer_PositionBuffer_t);
		if (FAILED(hr))
		{
			gpFile = fopen(gszLogFileName, "a+");
		...
		hr = gpID3D11DeviceContext->Map(
			gpID3D11Buffer_PositionBuffer_t,
			0,
...
void display(void)
{
	...
	gpID3D11DeviceContext->IASetVertexBuffers(0 , 1 , &gpID3D11Buffer_PositionBuffer , &Strid , &offset);
	...
	gpID3D11DeviceContext->IASetVertexBuffers(0 , 1 , &gpID3D11Buffer_PositionBuffer_t , &Strid , &offset);
