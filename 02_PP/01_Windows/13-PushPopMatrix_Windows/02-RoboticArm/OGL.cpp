...
GLuint mvpMatrixUniform = 0; // model view projection matrix
...
void display(void)
{
	...
	// triangle
	{
		...
		// sun
		modelMatrix = modelMatrix * vmath::rotate((GLfloat)shoulder, 0.0f, 0.0f, 1.0f);
		...
		modelMatrix = modelMatrix * vmath::translate(1.0f, 0.0f, 0.0f);
		modelMatrix = modelMatrix * vmath::rotate((GLfloat)elbow, 0.0f, 0.0f, 1.0f);
		modelMatrix = modelMatrix * vmath::translate(1.0f, 0.0f, 0.0f);
		...
		modelMatrix = modelMatrix * vmath::translate(0.77f, 0.0f, 0.0f);
		modelMatrix = modelMatrix * vmath::rotate((GLfloat)wrist, 0.0f, 0.0f, 1.0f);
		modelMatrix = modelMatrix * vmath::translate(0.25f, 0.0f, 0.0f);
		...
		modelMatrix = modelMatrix * vmath::scale(0.5f, 0.5f, 1.0f);
