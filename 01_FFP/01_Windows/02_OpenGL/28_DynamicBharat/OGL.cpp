...
GLfloat y_letterT = 0.15f;

GLfloat flagforB = 0.0f;
GLfloat flagforH = 0.0f;
GLfloat flagforA = 0.0f;
GLfloat flagforR = 0.0f;
GLfloat flagforA2 = 0.0f;
GLfloat flagforT = 0.0f;

GLuint TextureBharat = 0;
...
int initialize(void)
{
	...
	bResult = loadGlTexture(&TextureBharat, MAKEINTRESOURCE(MY_TEXTURE_BITMAP));
...
void display(void)
{
	...
	//glLoadIdentity();
	//glTranslatef(-0.7f, -0.75f, -3.0f);
	//glBindTexture(GL_TEXTURE_2D, TextureBharat);
	//glBegin(GL_QUADS);
	//{
...
//orange - 1.0f, 0.403f, 0.11f
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforB);
		glVertex3f(0.8f, 0.835f, 0.0f);
		glVertex3f(0.5f, 0.835f, 0.0f);
		glVertex3f(0.5f, 0.9f, 0.0f);
		glVertex3f(0.8f, 0.9f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforB);
		glVertex3f(0.8f, 0.765f, 0.0f);
		glVertex3f(0.5f, 0.765f, 0.0f);
		glVertex3f(0.5f, 0.825f, 0.0f);
		glVertex3f(0.8f, 0.825f, 0.0f);
	...
	{
		glColor4f(0.015f, 0.415f, 0.219f, flagforB);
		glVertex3f(0.8f, 0.7f, 0.0f);
		glVertex3f(0.5f, 0.7f, 0.0f);
		glVertex3f(0.5f, 0.765f, 0.0f);
		glVertex3f(0.8f, 0.765f, 0.0f);
...
void drawLetterH(void) {
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforH);
		glVertex3f(0.8f, 1.035f, 0.0f);
		glVertex3f(0.5f, 1.035f, 0.0f);
		glVertex3f(0.5f, 1.1f, 0.0f);
		glVertex3f(0.8f, 1.1f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforH);
		glVertex3f(0.8f, 0.965f, 0.0f);
		glVertex3f(0.5f, 0.965f, 0.0f);
		glVertex3f(0.5f, 1.035f, 0.0f);
		glVertex3f(0.8f, 1.035f, 0.0f);
	...
	{
		glColor4f(0.015f, 0.415f, 0.219f, flagforH);
		glVertex3f(0.8f, 0.9f, 0.0f);
		glVertex3f(0.5f, 0.9f, 0.0f);
		glVertex3f(0.5f, 0.965f, 0.0f);
		glVertex3f(0.8f, 0.965f, 0.0f);
...
void drawLetterA(void) {
...

	{
		...
		glColor4f(0.015f, 0.415f, 0.219f, flagforA);
		glVertex3f(0.8f, 0.735f, 0.0f);
		glVertex3f(0.4f, 0.735f, 0.0f);
		glVertex3f(0.4f, 0.8f, 0.0f);
		glVertex3f(0.8f, 0.8f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforA);
		glVertex3f(0.8f, 0.665, 0.0f);
		glVertex3f(0.4f, 0.665f, 0.0f);
		glVertex3f(0.4f, 0.735f, 0.0f);
		glVertex3f(0.8f, 0.735f, 0.0f);
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforA);
		glVertex3f(0.8f, 0.6f, 0.0f);
		glVertex3f(0.4f, 0.6f, 0.0f);
		glVertex3f(0.4f, 0.665f, 0.0f);
		glVertex3f(0.8f, 0.665f, 0.0f);
...
void drawLetterR(void) {
...

	{
		...
		glColor4f(0.015f, 0.415f, 0.219f, flagforR);
		glVertex3f(0.6f, 0.735f, 0.0f);
		glVertex3f(0.1f, 0.735f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforR);
		glVertex3f(0.6f, 0.665, 0.0f);
		glVertex3f(0.1f, 0.665f, 0.0f);
		glVertex3f(0.1f, 0.735f, 0.0f);
		glVertex3f(0.6f, 0.735f, 0.0f);
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforR);
		glVertex3f(0.6f, 0.6f, 0.0f);
		glVertex3f(0.1f, 0.6f, 0.0f);
		glVertex3f(0.1f, 0.665f, 0.0f);
		glVertex3f(0.6f, 0.665f, 0.0f);
...
void drawLetterA2(void) {
...

	{
		...
		glColor4f(0.015f, 0.415f, 0.219f, flagforA2);
		glVertex3f(0.8f, 0.735f, 0.0f);
		glVertex3f(0.4f, 0.735f, 0.0f);
		glVertex3f(0.4f, 0.8f, 0.0f);
		glVertex3f(0.8f, 0.8f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforA2);
		glVertex3f(0.8f, 0.665, 0.0f);
		glVertex3f(0.4f, 0.665f, 0.0f);
		glVertex3f(0.4f, 0.735f, 0.0f);
		glVertex3f(0.8f, 0.735f, 0.0f);
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforA2);
		glVertex3f(0.8f, 0.6f, 0.0f);
		glVertex3f(0.4f, 0.6f, 0.0f);
		glVertex3f(0.4f, 0.665f, 0.0f);
		glVertex3f(0.8f, 0.665f, 0.0f);
...
void drawLetterT(void) {
	...
	{
		glColor4f(1.0f, 0.403f, 0.11f, flagforT);
		glVertex3f(0.1f, 0.535f, 0.0f);
		glVertex3f(-0.1f, 0.535f, 0.0f);
		glVertex3f(-0.1f, 0.6f, 0.0f);
		glVertex3f(0.1f, 0.6f, 0.0f);
	...
	{
		glColor4f(1.0f, 1.0f, 1.0f, flagforT);
		glVertex3f(0.1f, 0.465, 0.0f);
		glVertex3f(-0.1f, 0.465f, 0.0f);
		glVertex3f(-0.1f, 0.535f, 0.0f);
		glVertex3f(0.1f, 0.535f, 0.0f);
	...
	{
		glColor4f(0.015f, 0.415f, 0.219f, flagforT);
		glVertex3f(0.1f, 0.4f, 0.0f);
		glVertex3f(-0.1f, 0.4f, 0.0f);
		glVertex3f(-0.1f, 0.465f, 0.0f);
		glVertex3f(0.1f, 0.465f, 0.0f);
...
void uninitialized(void)
{
	...
	if (TextureBharat) {
		glDeleteTextures(1, &TextureBharat);
		TextureBharat = 0;
	}
