...
GLuint ldUniform = 0; // for diffuse light
GLuint kdUniform = 0; // for diffuse material
...
// Code
	...
	// cube
	{
		...
		rotationMatrix1 = vmath::rotate(angle_Pyramid, 1.0f, 0.0f, 0.0f);

		mat4 rotationMatrix2 = mat4::identity();
		rotationMatrix2 = vmath::rotate(angle_Pyramid, 0.0f, 1.0f, 0.0f);

		mat4 rotationMatrix3 = mat4::identity();
		rotationMatrix3 = vmath::rotate(angle_Pyramid, 0.0f, 0.0f, 1.0f);
