...
struct CBUFFER
{
	...
	XMMATRIX ProjectionMatrix; // same as OpenGL
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	d3dInputElementDesc[1].InputSlot= 1;  // normal will be second input slot
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		gpFile = fopen(gszLogFileName, "a+");
		fprintf(gpFile , "CreateBuffer Failed for normal buffer!!!");
		fclose(gpFile);
	...
	{
		gpFile = fopen(gszLogFileName, "a+");
		fprintf(gpFile , "CreateBuffer is Success for normal buffer !!!");
		fclose(gpFile);
	}
...
void display(void)
{
	...
	if(bLightEnabled == TRUE)
	{
		...
		// XMStoreFloat4(&constantBuffer.LightPosition , XMVectorSet(100.0f , 100.0f , 100.0f , 1.0f));
		constantBuffer.Ld = XMVectorSet(1.0f , 1.0f , 1.0f , 0.0f);
		constantBuffer.Kd = XMVectorSet(0.5f , 0.5f , 0.5f , 0.0f);
	...
	// set normal buffer into pipeline here
