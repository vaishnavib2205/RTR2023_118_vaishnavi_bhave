...
GLubyte checkImage[CHECK_IMAGE_WIDTH][CHECK_IMAGE_HEIGHT][4]; // array declared 
...
void loadGlTexture(void)
{
	...
	glPixelStorei(GL_UNPACK_ALIGNMENT, 1);  // as our checker board it black and white so only 1 is mentioned.
