...
void display(void)
{
	...
	//set polygon mode to filled although default mode is filled
	...
	//do transformations for arm while *******************glulibrary mdhe z axis ha x axis aahe*****************
	glRotatef( (GLfloat)shoulder, 0.0f, 0.0f, 1.0f); // because in glulib x axis has direction of z axis
	...
	//do transformation of forearm in MTRT (F) i.e. forearm
	
	glTranslatef(1.0f, 0.0f, 0.0f);
	glRotatef((GLfloat)elbow, 0.0f, 0.0f, 1.0f);
	glTranslatef(1.0f, 0.0f, 0.0f);   //2.9
	glPushMatrix();
	glScalef(2.0f, 0.5f, 1.0f);
	//glScalef(2.0f, 0.5f, 1.0f);
