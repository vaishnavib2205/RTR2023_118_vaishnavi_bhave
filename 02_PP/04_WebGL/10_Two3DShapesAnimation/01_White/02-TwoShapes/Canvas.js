...
{ 
    ...
    // rectangle
    {
        ...
        mat4.translate(modelViewMatrix , modelViewMatrix , [1.5, 0.0 , -4.0]); // source , target , values
        mat4.scale(modelViewMatrix , modelViewMatrix , [0.75, 0.75 , 0.75]); // source , target , values
        ...
        gl.drawArrays(gl.TRIANGLE_FAN, 12, 16);
        gl.drawArrays(gl.TRIANGLE_FAN, 16, 20);
        gl.drawArrays(gl.TRIANGLE_FAN, 20, 24);
        gl.bindVertexArray(null);
    }
