...
GLfloat lightPosition[] = {0.0f, 2.0f, -3.0f, 1.0f};
...
GLfloat spotAngle = 10.0f;

GLfloat exponent = 10.0f;
GLfloat lightAttenuationConstant = 1.0f;
...
void display(void)
{
	...
	for (GLfloat x = -10.0f; x < 10.0f; x = x + 0.5f)
	{
		for (GLfloat z = -10.0f; z < 10.0f; z = z + 0.5f)
		{
